...
function Sidebar({ children }) {
  ...
  return (
    <div className="flex h-screen relative">
      <nav className="fixed top-0 left-0 w-full h-full border-r bg-white space-y-8 sm:w-80">
        <div class="flex flex-col h-full">
          ...
          <div className="flex-1 flex flex-col h-full overflow-auto">
            ...
            <hr className="border-t mx-10 mb-8" />
            <div>
              ...
              <div className="py-4 px-4 border-t">
                <div className="flex items-center gap-x-4">
                  <img src="https://placehold.co/548x548" className="w-12 h-12 rounded-full" />
                  <div>
                    <span className="block text-gray-700 text-sm font-semibold">Jan Pm</span>
      ...
      <main className="flex-1 p-8 justify-center ml-80">{children}</main>
    </div>
  );
}
